const Post = ({ data, isShow, toggleModal }) => {
    ...
    return (
        <>
            {isShow && (
                <div id="popup-modal" className="fixed top-0 left-0 right-0 z-50  p-4 overflow-x-hidden overflow-y-auto md:inset-0  max-h-full flex flex-col items-center justify-center h-screen">
