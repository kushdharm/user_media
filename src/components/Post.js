const Post = ({ data, isShow, toggleModal }) => {
    ...
    return (
        <>
            {isShow && (
                <div id="popup-modal" className="fixed top-0 left-0 right-0 z-80   p-4 overflow-x-hidden overflow-y-auto md:inset-0  max-h-full flex flex-col items-center justify-center h-screen  shadow-[2px_2px_10px_2px_rgba(0,0,0,0.8)] backdrop-blur-sm bg-white/30">
